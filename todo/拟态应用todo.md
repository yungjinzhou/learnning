...
- 调度器事件循环代码兼容性优化
- 超融合异构内生安全支撑平台-异构可视化资源管理平台测试方案修改
- 调度器代码加密处理
- 构建调度器x86、arm镜像，提供部署文档
- 调度器配置文件说明
- 加密部分资料
- 大云license文档找
- 
...
```
1. kjb-menhu相关文件, scheduler外网转内网;
2. 电脑保密扫描及文件处理;
3. 事件循环代码开发与测试;
4. 超融合异构可视化资源管理平台测试方案修改;
5. kjb-技术方案修改（HASH文件防篡改、同步服务模块）;
6. kjb-建设方案修改（HASH文件防篡改、同步服务模块）;
7. 协助同事部署拟态组件;
